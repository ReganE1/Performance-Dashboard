...
def runDenodo_Composite_Defensive_Characteristics_Month(composite_code,reporting_currency,valuation_date,period_length):
    ...
    Sql = "select period_length, bull_count_month, bear_count_month, total_months, composite_performance_bull_month, benchmark_performance_bull_month, composite_performance_bear_month, benchmark_performance_bear_month, composite_net_performance_bull_month, composite_net_performance_bear_month, relative_net_performance_bull_month, relative_net_performance_bear_month from mondrian.i_cor_defensive_characteristics where period_length = '" + period_length + "' and expressed_currency = '" + reporting_currency + "' and composite_code ='" + composite_code + "' and valuation_date ='" + valuation_date + "'"
